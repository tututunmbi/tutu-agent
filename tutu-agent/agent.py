...
3. **Content Bank** — Backlog of content ideas. When Tutu shares an idea or you generate one, add it here too.
...
- When a new content idea comes up in conversation, add it to the Content Bank (not just the calendar).
